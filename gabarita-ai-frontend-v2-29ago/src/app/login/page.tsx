...
const LoginPage: React.FC = () => {
  ...
  const { login, isPaymentPending } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (isPaymentPending()) {
          // Se há pagamento pendente, redirecionar para planos com aviso
          router.push('/planos?payment_pending=true');
        } else {
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/recuperar-senha" className="text-blue-600 hover:text-blue-700 font-medium">
                  Esqueceu a senha?
                </Link>
              </div>
            </div>
