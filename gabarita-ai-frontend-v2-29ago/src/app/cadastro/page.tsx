...
const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await executeAsync(
      ...
      {
        successMessage: 'Conta criada com sucesso! Bem-vindo ao Gabarita AI!',
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Junte-se a milhares de estudantes que já estão aprovando com nossa IA
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Ganhe 7 dias grátis do plano Premium ao se cadastrar hoje.
              </p>
            ...
            <div className="mt-6 text-center">
              ...
              <div className="text-sm text-gray-600">estudantes já aprovados</div>
            </div>
          </div>
        </div>
      </div>
